...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO corona(nokp, nama_pelajar, kelas, jenis_vaksin, tarikh_vaksin)"
    . "VALUES('$nokp', '$nama_pelajar', '$kelas', '$jenis_vaksin', '$tarikh_vaksin')");
